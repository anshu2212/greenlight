...
class RoomsController < ApplicationController
  ...
  def create
    ...
    return redirect_to "/u/home", flash: { alert: I18n.t("room.meeting_limit") } if room_limit_exceeded
    ...
    return redirect_to "/u/home", flash: { alert: I18n.t("room.create_meeting_error") } unless @room.save
